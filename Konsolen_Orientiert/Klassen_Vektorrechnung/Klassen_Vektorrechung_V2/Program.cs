...
namespace Klassen_Vektorrechung
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (auswahl == 1)//Vektor eins vs Vektor zwei
            {
                
            }
            else if (auswahl == 2)//Vektor eins vs Ursprung
            {

            }
            else if (auswahl == 3)//Vektor zwei vs Ursprung
            {

            }
            else if (auswahl == 4)//Alles "Zusammen" Gerechnet
            {
